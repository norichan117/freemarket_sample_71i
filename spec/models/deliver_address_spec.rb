...
describe DeliverAddress do
  describe '#create' do
    # 1
    it "is valid with a user_id a deliver_family_name and a deliver_first_name and a deliver_family_name_kana and a deliver_first_name_kana and a deliver_yubin_bango and a deliver_todofuken and a deliver_shichoson and a deliver_banchi" do
      user = create( factory :user )
    ...
    it "is invalid without a deliver_family_name" do
      ...
      expect(deliver_address.errors[:deliver_family_name]).to include("can't be blank")
    end
    ...
    it "is invalid without a deliver_first_name" do
      ...
      deliver_address.valid?
      expect(deliver_address.errors[:deliver_first_name]).to include("can't be blank")
    end
    ...
    it "is invalid without a deliver_family_name_kana" do
      ...
      deliver_address.valid?
      expect(deliver_address.errors[:deliver_family_name_kana]).to include("can't be blank")
    end
    # 5
    it "is invalid without a deliver_first_name_kana" do
      deliver_address = build(:deliver_address, deliver_first_name_kana: nil)
      deliver_address.valid?
      expect(deliver_address.errors[:deliver_first_name_kana]).to include("can't be blank")
    end
    ...
    it "is invalid without a deliver_yubin_bango" do
      ...
      deliver_address.valid?
      expect(deliver_address.errors[:deliver_yubin_bango]).to include("can't be blank")
    end
    ...
    it "is invalid without a deliver_todofuken" do
      ...
      deliver_address.valid?
      expect(deliver_address.errors[:deliver_todofuken]).to include("can't be blank")
    end
    ...
    it "is invalid without a deliver_shichoson" do
      ...
      deliver_address.valid?
      expect(deliver_address.errors[:deliver_shichoson]).to include("can't be blank")
    end    
    ...
    it "is invalid without a deliver_banchi" do
      ...
      deliver_address.valid?
      expect(deliver_address.errors[:deliver_banchi]).to include("can't be blank")
    end       
  end
end
